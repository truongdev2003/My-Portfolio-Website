...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "truongdev2003@gmail.com",
    href: "mailto:truongdev2003@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/xu%C3%A2n-tr%C6%B0%E1%BB%9Dng-l%C6%B0%C6%A1ng-86721a397/",
    content: "/luongxuantruong",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/truongdev2003",
    content: "/luongxuantruong",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Lương Xuân Trường</p>
